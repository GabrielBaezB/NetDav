...
class ServiciosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create servicio" do
    assert_difference("Servicio.count") do
      post servicios_url, params: { servicio: { nombre: @servicio.nombre, valor: @servicio.valor } }
    end
  ...
  test "should update servicio" do
    patch servicio_url(@servicio), params: { servicio: { nombre: @servicio.nombre, valor: @servicio.valor } }

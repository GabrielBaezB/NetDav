...
class PromocionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create promocion" do
    assert_difference("Promocion.count") do
      post promocions_url, params: { promocion: { estado: @promocion.estado, fecha_vigencia: @promocion.fecha_vigencia, nombre: @promocion.nombre } }
    end
  ...
  test "should update promocion" do
    patch promocion_url(@promocion), params: { promocion: { estado: @promocion.estado, fecha_vigencia: @promocion.fecha_vigencia, nombre: @promocion.nombre } }
